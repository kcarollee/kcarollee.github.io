...
// https://cdn.jsdelivr.net/npm/three@0.128.0/examples/jsm/objects/MarchingCubes.js
	...
	const testFunc = (x, y, z) => {
		...
		g = Math.min(sphereFunc1(x, y, z), g);
...
// CAMERA
	...
	let marchingCubesStatic = new MarchingCubes(30.0, 30.0, 30.0,10.0,10.0,10.0, 0, 0, 0, testFunc, 0.65, 3);
    marchingCubesStatic.updateCubes();

marchingCubesStatic.getMesh().visible = false;
    let showMoving = true;
    ...
    marchingCubesMoving.getMesh().visible = true;
...
/*
	...
	*/
	...
	function render(time){
		...
		scene.rotation.x = step * 0.001;
		scene.rotation.y = step * 0.001;
		scene.rotation.z = step * 0.001;
